...
<head>
	...
	<body>
		<!-- 悬浮 -->
		<div class="box" style="right: 0px;">
		<a href="javascript:;" onmouseover="onlicks()">
			<span id="boxtitle" class="title">在线客服</span></a>
		    <ul>
		        <li class="box_tel">
		        ...
		        <li><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3123641388&amp;site=qq&amp;menu=yes">
		        	<img border="0" width="100%" src="http://gethuli.com:80/img/protal/mainIndex/202.jpg" alt="我们竭诚为您服务！" title="我们竭诚为您服务！"></a></li>
		        <li class="ewm">
		...
		<div class="header">
			...
			<div class="header-body">
				<a class="Hbody-left">欢迎进入佳佳康复首页</a>
				<a class="Hbody-right">400-616-0909 &nbsp; &nbsp; 
					周一至周五:10:30~7:00
				</a>
			</div>
			<!-- 导航栏 -->
			...
			<!-- 展示图 -->
			<div class="main" style="background: url('<%=basePath%>img/index/main/main.jpg') no-repeat; background-position: center;"></div>

			<!-- 产品简介 -->
			<div class="content">
				<ul>
					<li>
						<img src="<%=basePath%>img/index/main/01.png">
						<div class="Cfont">
							<a>优质社区</a>
							<br>
							<a>随时随地在佳佳聊康复</a>
					...
					<li>
						<img src="<%=basePath%>img/index/main/02.png">
						<div class="Cfont">
							<a>优质内容</a>
							<br>
							<a>康复见解独树一帜</a>
