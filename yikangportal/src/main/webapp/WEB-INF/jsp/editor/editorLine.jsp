...
<div class="allImp">
	<div class="all-top">	
		<ul class="act-type">
			...
			<li style="border-right: 1px solid #d6d6d6;"><span><img src="<%=basePath%>img/protal/editor/img/线上未点击.png"/></span>发布线上活动</li>
			<li class="act-type1"><span><img src="<%=basePath%>img/protal/editor/img/线下点击.png"/></span>发布线下活动</li>
		</ul>			
	</div>
	<div class="main-left">
			<h2>请在这里输入标题</h2>
