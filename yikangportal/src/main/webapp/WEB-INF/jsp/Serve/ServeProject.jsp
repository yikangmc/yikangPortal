			...
			<div id="dv_3" class="dv_home">
				...
				<div class="v1">
					<div style=" height: 150px;">
						<div class="block"><div id="font_selete"></div></div>
						...
						<div class="block" id="font_titleone" style="margin-top: 55px; text-align: center; width: 240px;">${medicinalApparatus.maName }1.针头</div>
						<button id="btn_fonts" onclick="myFunction()" value="">点击购买</button>
					</div>
					<div style=" height: 150px;">
						<div class="block"><div id="font_selete1"></div></div>
						<div class="block"><img style="width: 125px; height: 125px;" src="<%=basePath%>/img/ServeImg/fl.png"></div>
						<input type="hidden" name="medicinalApparatuId" value="${medicinalApparatus.medicinalApparatuId }"></input>
						<div id="font_titleone1" class="block" style="margin-top: 55px; text-align: center; width: 240px;">${medicinalApparatus.maName }1.敷料</div>
						<button id="btn_fonts1" onclick="myFunction2()" value="">点击购买</button>
					</div>
				</div>
			</div>
