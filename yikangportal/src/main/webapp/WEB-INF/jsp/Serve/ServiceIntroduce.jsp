		...
		<div class="dv_body">
			...
			<div class="dv_title">
				<ul>
					...
					<li class="font-bottom">一段主页上的简介就是给你看看的</li>
				</ul>
			</div>
			<img style=" width: 100%;" src="img/protal/ServeImg/border.png" />
								...
								<ul>
									...
									<li>
										<div style="width:135px;">
											<img style="width: 135px; height: 135px;" src="img/protal/ServeImg/fl.png">
										</div>
									</li>
						...
						<li>
							...
							<div class="shangping" >
								<ul>
									...
									<li>
										<div style="width:135px;">
											<img style="width: 135px; height: 135px;" src="img/protal/ServeImg/zt.png">
										</div>
									</li>
									<li id="font_titleone2" style="padding-left: 40px;">
										1.针头
									</li>
									<li style="padding-left: 40px;">
										<button id="btn_fonts3" onclick="myFunction2()" value="">点击购买</button>
									</li>
								</ul>
							</div>
						</li>
	...
	<style type="text/css">
		...
		*{ margin: 0px; padding: 0px;}
		...
		.dv_topimg {
			width: 100%;
			height: 300px;
			background: url(img/protal/ServeImg/ServiceIntroduce/1.jpg) no-repeat;
